                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-condensed" style="color: white; margin-top: 40px;">
                                    ...
                                    %>
                                    <tr>
                                        <td><%=reservita.getId_cliente().getNombre()%></td>
                                        ...
                                        <td><a href="modificarreserva?idReserva=<%=reservita.getId_reserva()%>" class="form-control" style="color: #ff3333; font-weight: bold; font-size: 13px; text-align: center">Modificar</a></td>
