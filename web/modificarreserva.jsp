        ...
        <div class="container">
                        ...
                        <div class="col-md-10 color_fondo">
                            ...
                            <div class="row" style="margin-top: 20px;">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">            
                                        <div class="col-md-10">
                                            <label style="color: #9c917a">Id_Venta:</label>
                                            <input id='nombres' name="idReserva" value="<%=reserva.getId_reserva()%>" disabled="" required class="form-control">
                                            ...
                                            <input id='nombres' name="nombres" value="<%=reserva.getId_cliente().getNombre()%>" required class="form-control">
                                            
                                            <input id='nombres' name="idCliente" value="<%=reserva.getId_cliente()%>" required class="form-control">
                                            <label style="color: #9c917a">Apellidos:</label>
                                            <input id='apellidos' name="apellidos" value="<%=reserva.getId_cliente().getApellido()%>" required class="form-control">
                                            <label style="color: #9c917a">Teléfono:</label>
                                            <input id='telefono' name="telefono" required value="<%=reserva.getId_cliente().getTelefono()%>" class="form-control">
                                            <label style="color: #9c917a">Email:</label>
                                            <input type="email" id='email' name="email" value="<%=reserva.getId_cliente().getCorreo()%>" required class="form-control">   
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"> 
                                                    <select class="form-control" name="dia" style="width: 80px;">
                                                        <option value="No se ha seleccionado">Día</option>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-5 col-xs-5">
                    <p style="color: #e59201; padding: 0 20px 0 20px; text-align: justify;">Ingeniería de Software II</p>
                </div>
