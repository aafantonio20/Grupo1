            ...
            <main>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 color_fondo table-responsive">
                        <div class="row">
                            <div class="col-lg-12">
                                <p style="font-size: 22px; color: #ffc831;">!El producto fue eliminado exitosamente!</p>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="row">
                                   ...
                                   <div class="col-lg-12" style="margin-top: 15px;">
                                       <a href="obtenercategorias" style="color: #ffc831; font-size: 18px; ">CREAR PRODUCTO</a> 
                                    </div>
                                </div>
                            </div>
                        </div>
